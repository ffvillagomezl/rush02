...
# include <unistd.h>
# include <stdlib.h>
# include <fcntl.h> // Necesario para la flag O_RDONLY en open()

// Prototipos de lectura y parseo
...
// Prototipos de troceado de grupos
...
// Prototipos de evaluación y escritura
